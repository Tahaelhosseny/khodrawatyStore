...
public class WaitingList extends AppCompatActivity
{
    ...
    private void request()
    {
        ...
        MakeRequest makeRequest = new MakeRequest("/Requests/order_wait", "1", params, this);
                    ...
                    try {
                        ...
                        else if(status.equals("ok"))
                        {
                            ...
                            for (int i = 0 ; i<jsonArray.length() ; i++)
                            {
                                ...
                                OrderModel categoryModel = new OrderModel(jsonObject1.getString("id"),jsonObject1.getString("time"),jsonObject1.getString("name"),jsonObject1.getString("phone") , jsonObject1.getString("email") , jsonObject1.getString("price") , jsonObject1.getString("product"),"0");
