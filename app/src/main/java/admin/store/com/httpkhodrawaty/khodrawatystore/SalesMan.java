                    ...
                    try {
                        ...
                        else if(status.equals("ok"))
                        {
                            ...
                            for (int i = 0 ; i<jsonArray.length() ; i++)
                            {
                                ...
                                SalesManModel salesManModel = new SalesManModel(jsonObject1.getString("id"),jsonObject1.getString("name"),jsonObject1.getString("city")  , jsonObject1.getString("city_id") , jsonObject1.getString("email"),jsonObject1.getString("password"),jsonObject1.getString("phone"));
